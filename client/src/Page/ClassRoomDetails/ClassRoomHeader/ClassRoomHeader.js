        ...
        <div className="flex flex-row   bg-white  ">
          <div className="flex flex-col px-6">
            ...
            <div className="mt-2 flex flex-row items-center space-x-5">
              ...
              <div className="flex h-20 w-40 flex-col items-center justify-center rounded-md border border-dashed border-green-400 transition-colors duration-100 ease-in-out  ">
                <div className="flex flex-row items-center justify-center">
                  <svg
                    className="mr-3 fill-gray-500/95"
                    version="1.1"
